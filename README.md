...
```bash
npm install --save @xstudio/ckeditor5-build-classic
```
...
<script src="./node_modules/@xstudio/ckeditor5-build-classic/build/ckeditor.js"></script>
<script>
	ClassicEditor
...
```js
import ClassicEditor from '@xstudio/ckeditor5-build-classic';

// Or using the CommonJS version:
// const ClassicEditor = require( '@xstudio/ckeditor5-build-classic' );
